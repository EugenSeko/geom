...
public class Console_in_out {
    ...
    static void programmRun() throws IOException {
        ...
        while(!s.equals("E") | !s.equals("e")) {
            ...
            figureIntersection(inters);  inters = ""; b=b1=b2=b3=false;
        }
    }
    ...
    static void toScreen(Object[]ob){
        ...
        boolean b;
        for (Object anOb : ob) {
            b = !anOb.equals(-0.0) & !anOb.equals(true) & !anOb.equals(false);
            if (b) {
    ...
    static void toScreen(Object[][]ob){
        ...
        boolean b;
        for (Object[] anOb : ob) {
            for (int k = 0; k < ob[0].length; k++) {
                b = !anOb[k].equals(-0.0) & !anOb[k].equals(true) & !anOb[k].equals(false);
                if (b) {
                    System.out.println(anOb[k]);
                }
                if (!b) {
                    count++;
                }
    ...
    static void toScreen(Object[][][]ob){
        ...
        for (Object[][] anOb : ob) {
            for (int k = 0; k < ob[0].length; k++) {
                for (int j = 0; j < ob[0][0].length; j++) {
                    b = !anOb[k][j].equals(-0.0) & !anOb[k][j].equals(true) & !anOb[k][j].equals(false);
                    if (b) {
                        System.out.println(anOb[k][j]);
                    }
                    if (!b) {
                        count++;
                    }
